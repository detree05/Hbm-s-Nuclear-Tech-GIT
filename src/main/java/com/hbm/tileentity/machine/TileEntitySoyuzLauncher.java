...
public class TileEntitySoyuzLauncher extends TileEntityMachineBase implements ISidedInventory, IEnergyReceiverMK2, IFluidStandardReceiver, IGUIProvider, IFluidCopiable {
	...
	public int orbital() {
		...
		if(slots[2] != null && (slots[2].getItem() == ModItems.sat_gerald || slots[2].getItem() == ModItems.sat_derald || slots[2].getItem() == ModItems.sat_sadald || slots[2].getItem() == ModItems.sat_lunar_miner)) {

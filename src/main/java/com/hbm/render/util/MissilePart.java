...
public class MissilePart {
	...
	public static void registerAllParts() {
		...
		MissilePart.registerPart(ModItems.sat_sadald, PartType.WARHEAD, 7, 5, ResourceManager.mp_w_fairing, ResourceManager.mp_w_fairing_tex).hideInventoryModel();
	...
	public static void registerAllPartsServer() {
		...
		MissilePart.registerPart(ModItems.sat_sadald, PartType.WARHEAD, 7, 5);
